...
import ViewOptionsComponent from './Header/ViewOptionsComponent';
import CreateBucketPopUpComponent from './Buckets/InputPopUpComponent';
import QRCodeComponent from '../components/MyAccount/QRCodeComponent';
import StorageInfoComponent from './MyAccount/Storage/StorageInfoComponent';
import AddCreditComponent from './MyAccount/Balance/AddCreditComponent';
import PopUpComponent from './Common/PopUpComponent';
import PinOptionComponent from './MyAccount/Settings/PIN/PinOptionComponent';
import AnimatedWindowComponent from "./Common/AnimatedWindowComponent";
...
MainComponent.propTypes = {
    ...
    changePasswordPopupStatus: PropTypes.func,
    ...
    getBucketId: PropTypes.func,
    getBuckets: PropTypes.func,
    getFiles: PropTypes.func,
    getLoadingSyncEntry: PropTypes.func,
    getSyncEntryLoadingCount: PropTypes.func,
    hideCreateBucketInput: PropTypes.func,
    hideSyncWindow: PropTypes.func,
    interpolate: PropTypes.func,
    interpolateBackground: PropTypes.func,
    isChangePasswordPopupShown: PropTypes.bool,
    isPinOptionsShown: PropTypes.bool,
    isSelectionMode: PropTypes.bool,
    isSingleItemSelected: PropTypes.bool,
    isSyncWindowShown: PropTypes.bool,
    redirectToPinCodeGenerationScreen: PropTypes.func,
    renderSyncQueueEntry: PropTypes.func,
    selectAll: PropTypes.func,
    setSorting: PropTypes.func,
    showSyncWindow: PropTypes.func,
