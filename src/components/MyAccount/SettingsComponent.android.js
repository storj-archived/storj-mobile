    ...
    return(
        <View style = { styles.mainContainer } >
            ...
            <ScrollView showsVerticalScrollIndicator = { false } decelerationRate = { 'normal' } >
                ...
                <View style = { styles.checkboxPhotosContainer }>
                    <TouchableOpacity 
                        ...
                        <Image 
                            ...
                            resizeMode = 'contain'
                            source = { 
                                props.getStateObject().syncPhotos 
                ...
                <View style = { styles.checkboxPhotosContainer }>
                    <TouchableOpacity 
                        onPress = { props.syncMoviesAction }
                        style = { styles.flexRow } >
                        <Image 
                            style = { styles.icon } 
                            resizeMode = 'contain'
                            source = { 
                                props.getStateObject().syncMovies 
                                ? require('../../images/Icons/ListItemSelected.png')
                                : require('../../images/Icons/ListItemUnselected.png') } />
                ...
                <View style = { styles.checkboxPhotosContainer }>
                    <TouchableOpacity 
                        ...
                        <Image 
                            ...
                            resizeMode = 'contain'
                            source = { 
                                props.getStateObject().syncDocuments 
                                ? require('../../images/Icons/ListItemSelected.png')
                                : require('../../images/Icons/ListItemUnselected.png') } />
                ...
                <View style = { styles.checkboxPhotosContainer }>
                    <TouchableOpacity 
                        onPress = { props.syncMusicAction }
                        style = { styles.flexRow } >
                        <Image 
                            style = { styles.icon } 
                            resizeMode = 'contain'
                            source = { 
                                props.getStateObject().syncMusic 
                                ? require('../../images/Icons/ListItemSelected.png')
                                : require('../../images/Icons/ListItemUnselected.png') } />
                ...
                <View style = { styles.underline }/>
                <TouchableOpacity style = { styles.optionsContainer } onPress = { changePINOptionStatus }> 
